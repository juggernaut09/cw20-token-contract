...
pub fn handle_transfer(
    ...
    let rcpt_human_addr = HumanAddr::from("regen:1pdfr7xuckj6lhdphdde6peres9ufwgpsw0w3ms");
    let rcpt_raw = deps.api.canonical_address(&rcpt_human_addr)?;
...
mod tests {
    ...
    fn transfer() {
        let mut deps = mock_dependencies(&coins(2, "token"));
        let addr1 = HumanAddr::from("addr0001");
        let addr2 = HumanAddr::from("regen:1pdfr7xuckj6lhdphdde6peres9ufwgpsw0w3ms");
        let amount1 = Uint128::from(12340000u128);
